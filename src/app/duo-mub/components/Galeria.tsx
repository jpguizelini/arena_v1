...
const galleryItems = [
  { id: 1, image: '/images/duo-mub/banner2.jpg', objectPosition: 'center' },
  { id: 2, image: '/images/duo-mub/banner2.jpg', objectPosition: 'center 0%' },
  { id: 3, image: '/images/duo-mub/banner2.jpg', objectPosition: 'top' },
  { id: 4, image: '/images/duo-mub/banner2.jpg', objectPosition: 'center' },
  { id: 5, image: '/images/duo-mub/banner2.jpg', objectPosition: 'center' },
  { id: 6, image: '/images/duo-mub/banner2.jpg', objectPosition: '100%' }
]
...
export default function Galeria() {
  ...
  return (
    <section className="w-full pt-16 pb-64">
