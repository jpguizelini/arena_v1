        ...
        <div className="w-full flex flex-col items-center justify-center">
            ...
            <Card3D className="group relative mx-[57px] mt-[15px]" glowClassName="pointer-events-none absolute inset-0 -z-10 opacity-0">
                <div className="relative px-8 pt-8 pb-10 text-center transition-shadow duration-200 group-hover:shadow-[0_0_28px_rgba(195,211,63,0.28),0_0_28px_rgba(7,156,158,0.22)] bg-black rounded-xl">
                    ...
                    <div className="relative z-10 mt-[13px] mb-[2px] flex flex-col">
                        <motion.p
                            className="text-white leading-8 text-[15px]"
                            initial={{ opacity: 0, y: 20 }}
                            whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: true, amount: 0.3 }}
                            transition={{ duration: 0.5, delay: 0, ease: "easeOut" }}
                        >
                            Araçatuba  ·  Aramina  ·  <b className="text-[20px]">Araraquara</b>  ·  Barretos  ·  Batatais  ·  <b className="text-[20px]">Bauru</b>  ·  Birigui  ·  Brodowski  ·  Buritizal
                        </motion.p>
                        <motion.p
                            className="text-white leading-8 text-[15px]"
                            initial={{ opacity: 0, y: 20 }}
                        ...
                        >
                            Campinas  ·  <b className="text-[20px]">Franca</b>  ·  Guará  ·  Iguarapava  ·  Ipuã  ·  Ituverava  ·  Jardinópolis  ·  Jeriquara  ·  Jundiaí  ·  Miguelópolis
                        </motion.p>
                        <motion.p
                            className="text-white leading-8 text-[15px]"
                            initial={{ opacity: 0, y: 20 }}
                        ...
                        >
                            Monte Azul Paulista  ·  Morro Agudo  ·  Nuporanga  ·  Orlândia  ·  Osasco  ·  Pedregulho  ·  <b className="text-[20px]">Ribeirão Preto</b>
                        </motion.p>
                        <motion.p
                            className="text-white leading-8 text-[15px]"
                            initial={{ opacity: 0, y: 20 }}
                        ...
                        >
                            Sales Oliveira  ·  <b className="text-[20px]">São Carlos</b>  ·  São Joaquim da Barra  ·  São José do Rio Preto  ·  Sertãozinho  ·  Sumaré
                        </motion.p>
                        <motion.p
                            className="text-white leading-8 text-[15px]"
                            initial={{ opacity: 0, y: 20 }}
